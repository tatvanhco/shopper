        ...
        <div className='fixed inset-0 bg-black bg-opacity-20 flex items-center justify-center'>
            <div className='bg-white w-[450px] p-7'>
                ...
                <form action="">
                    ...
                    <div>
                        <label htmlFor="modalSearchCategories" className='hidden'>Category:</label>
                        <select name="" id="modalSearchCategories" className='w-full py-3 px-5 border border-[#e5e5e5] '>
