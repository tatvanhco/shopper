        ...
        <Fragment>
            <div className="header">
                <div className="container">
                    <div className={clsx(styles.headerContact, 'd-f')}>
                        ...
                        <div className="headerContactLeft">
                            <ul className={clsx('headerContactLeftItems', 'd-flex', 'ul')}>
                                <li className={clsx('headerContactLeftItem')}>Shipping</li>
                                <li className={clsx('headerContactLeftItem')}>FAQ</li>
                                <li className={clsx('headerContactLeftItem')}>Contact</li>
