                        ...
                        <div className={clsx(styles.headerContact, 'd-flex')}>
                            <div className="headerContactRight">
                                <ul className={clsx('headerContactRightItems', 'ul', 'd-flex')}>
                                    <li className={clsx('headerContactRightItem', 'd-flex')}>
                                        <span className={clsx('material-symbols-outlined', styles.icon)}>local_shipping</span>
                                        <p className={clsx(styles.titleShip)}>FREE SHIPPING WORLDWIDE</p>
                                    </li>
                                    <li className={clsx('headerContactRightItem', 'd-flex', 'p-4p')}>
                            ...
                            <div className="headerContactLeft">
                                <ul className={clsx('headerContactLeftItems', 'd-flex', 'ul')}>
                                    ...
                                    <li className={clsx('headerContactLeftItem')}>
                                        <img
                                            className={clsx('img-icon', styles.icon)}
